...
public class FirstVersionCrudProcess<E extends BaseEntity> implements CrudProcess<E> {

    private final List<E> list = new ArrayList<>();

    public FirstVersionCrudProcess() {
        System.out.println("FirstVersionCrudProcess");
    }
